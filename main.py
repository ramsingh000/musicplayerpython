...
def music_name():
    ...
    return last(my_music[music_number].split(os.path.sep))

def play_music():
    global music_number, my_music, player
...
# Modify this path to point to your music folder (Windows-style path)
music_folder = r'F:\musicproject\music'

my_music = glob.glob(os.path.join(music_folder, '*.mp3'))
